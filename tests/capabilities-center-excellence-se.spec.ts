...
test.describe('Unosquare.com Capabilities Center Excellence SE Page', () => {
  test.beforeEach(async ({ page }) => {
    await page.goto('https://www.unosquare.com/capabilities/?section=center-excellence-se');
  ...
  test('Search box works if present', async ({ page }) => {
    ...
    for (const selector of searchSelectors) {
      if (await page.$(selector)) {
        ...
        await randomDelay();
        await expect(page).not.toHaveURL('https://www.unosquare.com/capabilities/?section=center-excellence-se');
        break;
      }
    }
